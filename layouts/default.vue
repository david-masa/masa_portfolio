     ...
     <div class="w-64 mt-24 ml-2 relative md:fixed ">
       <div class="flex">
         ...
         <div>
           ...
           <p class="text-xs text-justify">駆け出しエンジニアのMasaです。よろしくお願いします！</p>
         </div>
       </div>
       <div class="flex justify-around mt-5 text-xs">
        ...
        <a href="https://twitter.com/DavidMasa11" target="_blank" rel="noopener noreferrer">
          <button>
            <fa-layers full-width class="fa-2x block mx-auto mb-1">
              <fa :icon="faTwitter" />
            </fa-layers>
        ...
        <a href="https://github.com/david-masa" target="_blank" rel="noopener noreferrer">
          <button>
            <fa-layers full-width class="fa-2x block mx-auto mb-1">
              <fa :icon="faGithub" />
            </fa-layers>
